...
class HomeScreenJudge extends StatefulWidget {
  final String userName;

  const HomeScreenJudge({super.key, required this.userName});

  @override
  State<HomeScreenJudge> createState() => _HomeAdvocateScreenState();
}

class _HomeAdvocateScreenState extends State<HomeScreenJudge>
...
// can be "not_submitted", "pending", "approved"
 // This would come from backend/SharedPreferences
  ...
  Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => const VerifyJudgeScreen()),
  ).then((value) {
